...
constexpr float kMinClosedPosition_deg = 40;  // Change this to a value where the servo has displaced the appropriate amount.
constexpr float kMaxClosedPosition_deg = 80; // Change this to a value where the servo has displaced the appropriate amount.
