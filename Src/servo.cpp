...
Servo::Servo(uint32_t update_period_ms, DRV8873 *driver, Encoder *encoder, Config cfg, PID::Params vel_pid_params,
...
void Servo::update() {
    ...
    velocity = .97 * velocity + .03 * to_rad_at_output(counts) / (period_ms / 1000.0f);  // rad / s
